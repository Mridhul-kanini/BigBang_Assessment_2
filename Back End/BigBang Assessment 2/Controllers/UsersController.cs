...
namespace BigBang_Assessment_2.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(BigBangContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<User>>> GetUsers()
        {
            ...
            // You can remove the decryption code since the passwords are stored as plain text
        ...
        // GET: api/Users/5/Patient
        [HttpGet("{id}/Patient")]
        public async Task<ActionResult<Patient>> GetPatientByUserId(int id)
        {
            if (_context.Users == null)
            {
                return NotFound();
